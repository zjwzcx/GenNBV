...
from stable_baselines3.common.evaluation import evaluate_policy, evaluate_policy_grid_obs
...
class EvalCallback_Grid_Obs(EventCallback):
    """
    Callback for evaluating an agent.
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            # episode_rewards, episode_lengths = evaluate_policy_grid_obs(
            #     self.model,
            #     self.eval_env,
            #     n_eval_episodes=self.n_eval_episodes,
            #     render=self.render,
